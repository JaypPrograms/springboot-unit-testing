...
public class GradebookControllerTest {
    ...
    @Mock
    StudentAndGradeService studentCreateeService;
    ...
    @Test
    public void createAValidGradeHttpRequestWithNonValidStudentId() throws Exception{
    ...
    @Test
    public void createAValidGradeHttpRequestWithInvalidGradeType() throws Exception{
